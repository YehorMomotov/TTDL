class Train {
  ...
  calculateTravelTime() {
    const arrivalTime = new Date(
      `${new Date().getFullYear()}-${new Date().getMonth()}-${new Date().getDate()}T${this.arrivalTime}`
    );
    const departureTime = new Date(
      `${new Date().getFullYear()}-${new Date().getMonth()}-${new Date().getDate()}T${this.departureTime}`
    );
  ...
  parseTime(key) {
    const result = new Date(
      `${new Date().getFullYear()}-${new Date().getMonth()}-${new Date().getDate()}T${this[key]}`
    );
